export const FILTERS_PAGE = {
  ...
  filterOperatorList: '.euiForm .euiFlexGroup--responsive [data-test-subj="filterOperatorList"] [data-test-subj="comboBoxInput"]',
  ...
  selectedFilter: '[data-test-subj="comboBoxOptionsList filterFieldSuggestionList-optionsList"]'
};
