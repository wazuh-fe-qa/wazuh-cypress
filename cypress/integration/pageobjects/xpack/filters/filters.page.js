export const FILTERS_PAGE = {
  ...
  filterOperatorList:
    '.euiForm .euiFlexGroup--responsive [data-test-subj="filterOperatorList"] [data-test-subj="comboBoxInput"]',
  filterParams: '[data-test-subj="filterParams"]',
  saveFilterButton: '[data-test-subj="saveFilter"]',
  stablishedFilter:
    '[data-test-subj="filter filter-enabled filter-key-rule.level filter-value-7 filter-unpinned"',
  pinFilterAction: '[data-test-subj="pinFilter"]',
  selectedOperator: '[title="is"]',
  pinnedFilter:
    '[data-test-subj="filter filter-enabled filter-key-rule.level filter-value-7 filter-pinned"]',
